...
public class SearchResultsPeoplePage extends BasePageWeb{
	private static Logger log=Logger.getLogger(SearchResultsPeoplePage.class);
	//create a constructor
	public SearchResultsPeoplePage() {
